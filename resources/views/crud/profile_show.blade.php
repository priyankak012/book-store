                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="d-flex">
                              <input class="form-control me-2" type="search" name="profile_search">
                                        ...
                                        <tbody>
                                            @foreach ($profiles as $index => $detail)
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{ asset($detail->profile) }}"
                                                            width="10%" height="9%"></td>
                                                    <td class="text-center">
                                                        <a href="{{route('admin.profile',$detail->id)}}" class="btn btn-info btn-sm">View</a>
                                                    </td>
                                                    <td class="text-center">
