...
<body>
    ...
    @if (Session::has('store'))
        <script>
            swal("Well Done", "data added is Successfully", "success");
        </script>
    @endif
    ...
    <section>
        <h2 id="Home">
            <div class="card mb-3">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfm5BKpKfNJcK4Cyy9XQMPqNX7DBuAGnecYg&usqp=CAU"
                ...
                <div class="card-body">
                    <blockquote class="blockquote mb-0 text-dark fw-bolder">
                        <p>
                            ...
                            1,000 years. To read is to voyage through time."</p>
        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget justo eu
                        justo tincidunt euismod.</p>
                </div>
            </div>
        </div>
        <!--Book title Information End-->
